...
import 'low_tire_pressure_model.dart';
export 'low_tire_pressure_model.dart';

class LowTirePressureWidget extends StatefulWidget {
  const LowTirePressureWidget({super.key});

  @override
  State<LowTirePressureWidget> createState() => _LowTirePressureWidgetState();
}

class _LowTirePressureWidgetState extends State<LowTirePressureWidget>
    with TickerProviderStateMixin {
  late LowTirePressureModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LowTirePressureModel());
              ...
              children: [
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Image.asset(
                      'assets/images/low_tire_pressure.png',
                      width: 300.0,
                      height: 300.0,
                      fit: BoxFit.contain,
                    ).animateOnPageLoad(
                        ...
                        children: [
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                16.0, 0.0, 16.0, 0.0),
                            child: Text(
                              'The low tire pressure light indicates that one or more of your tires are underinflated. This can lead to poor vehicle handling, reduced fuel efficiency, and increased tire wear.',
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                15.0, 10.0, 0.0, 0.0),
                            child: Text(
                              'Check Pressure: Use a gauge.\n\nAdd Air: Inflate tires.\n\nInspect Tires: Look for damage.\n\nProfessional Check: Consult a mechanic.',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    fontFamily: 'Inter',
